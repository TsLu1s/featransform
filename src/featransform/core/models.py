...
from featransform.core.enums import (
    FeatureType, ModelFamily, ImputationStrategy, 
    EncodingStrategy, SelectionStrategy, OptimizationMetric,
    TaskType
)
from featransform.core.constants import (
    DEFAULT_RANDOM_STATE, DEFAULT_N_JOBS
)
...
class TransformationResult:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "feature_types": {ft.value: sum(1 for f in self.feature_info if f.feature_type == ft) 
